...
PYTHONPATH=src python3 tools/validate_asset_catalog.py \
  ...
  --export-id living_room_kenney_v0_r5 \
  ...
  --output-dir exports/scene_engine/living_room_kenney_v0_r5 \
  --notes "Frozen size-normalized snapshot with protocol-aligned support_surfaces_v1 and expanded authored coverage for coffee-table, side-table, and tv-stand variants."
