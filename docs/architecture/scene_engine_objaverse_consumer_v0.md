# Scene-Engine Objaverse Consumer v0

This note defines the intended `vgm-scene-engine` handoff for the first
Objaverse-backed living-room asset snapshot.
...
- `DATA_ROOT/exports/scene_engine/living_room_objaverse_v0_r1/assets/...`
