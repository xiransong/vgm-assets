...
PYTHONPATH=src python3 tools/validate_asset_catalog.py \
  ...
  --export-id living_room_kenney_v0_r2 \
  ...
  --output-dir exports/scene_engine/living_room_kenney_v0_r2 \
  --notes "Frozen size-normalized snapshot for vgm-scene-engine consumption."
